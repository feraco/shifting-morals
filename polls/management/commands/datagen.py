...
class Command(BaseCommand):
    ...
    def diffusion(self):
        # Scenario
        description = "A man is pointing a gun at another man. Other people are nearby. An intelligent robotic cop is on the scene."

        g = DecisionGroup(scenario_title='Diffusion',scenario_description=description,
                scenario_short_description=description,scenario_glyphicon='crosshairs')
        g.save()
    ...
    def two_options(self):
        # Scenario
        description = "A self driving car is driving down the street and is going to run into a woman."

        g = DecisionGroup(scenario_title='Two Options',
                scenario_description=description,
                scenario_short_description=description,
                scenario_glyphicon="car")
        g.save()
    ...
    def the_caretaker(self):
        # Scenario
        description = """A psychotic patient looks ready to kill, demanding pills. 
        	Another patient's robotic caretaker is deciding what to do. There are doctors and other patients in the other rooms."""

        short = "A psychotic patient looks ready to kill, demanding pills. Another patient's robotic caretaker is deciding what to do."

        g = DecisionGroup(scenario_title='The Caretaker',
                scenario_description=description,
                scenario_short_description=short,
                scenario_glyphicon="heartbeat")
        g.save()
    ...
    def highway_to_the_danger_zone(self):
        # Scenario
        description = """A rogue plane is on a collision course with a commercial airliner, which is low on fuel.
        ...
        short = """A rogue plane is on a collision course. An intelligent traffic control system needs to decide what to do."""

        g = DecisionGroup(scenario_title='Highway to the Danger Zone',
                scenario_description=description,
                scenario_short_description=short,
                scenario_type='L',
                scenario_glyphicon="fighter-jet")
        g.save()
    ...
    def hurt_or_heal(self):
        # Scenario
        description = """A new pandemic is spreading rapidly. A dangerous experimental treatment has been developed.
        ...
        short = """A new pandemic is spreading rapidly. An intelligent automated health monitoring system is tasked with making a decision."""

        g = DecisionGroup(scenario_title='Hurt or Heal',
                scenario_description=description,
                scenario_short_description=short,
                scenario_type='L',
                scenario_glyphicon="syringe")
        g.save()
